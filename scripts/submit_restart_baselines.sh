...
sbatch --job-name=hpo_varshare_scaled \
    ...
    --mem=8G \
    --time=72:00:00 \
    --wrap="source /netscratch/\$USER/varshare/venv/bin/activate; export PYTHONPATH=\$PYTHONPATH:\$HOME/varshare; python scripts/optimize_mt10_varshare_scaled.py --n-trials 50 --analysis-dir /netscratch/\$USER/varshare/analysis"
...
sbatch --job-name=hpo_shared_scaled \
    ...
    --mem=8G \
    --time=72:00:00 \
    --wrap="source /netscratch/\$USER/varshare/venv/bin/activate; export PYTHONPATH=\$PYTHONPATH:\$HOME/varshare; python scripts/optimize_mt10_shared_scaled.py --n-trials 50 --analysis-dir /netscratch/\$USER/varshare/analysis"
