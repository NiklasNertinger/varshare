...
\begin{itemize}
    ...
    \item \textbf{Selective Task Gating:} To solve "Feature Interference", we are experimenting with a task-specific vector of learned boolean gates. If a task fundamentally disagrees with a specific shared feature, it can simply learn a $0.0$ gate to silence it, effortlessly bypassing the need to grow an enormous, penalized residual to override it.
\end{itemize}
