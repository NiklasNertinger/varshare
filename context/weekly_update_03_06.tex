...
To bridge this novelty gap and unlock the architecture's true potential, I have formally analyzed its strengths and weaknesses. Guided by this analysis, I have designed several tailored architectural improvements intended to either maximize its structural strengths or mitigate its existing flaws.
...
\begin{itemize}
    ...
    \item \textbf{Limited Geometric Expressivity:} Treating the residual strictly as a linear, additive weight shift ($w_t = \theta + \mu_t$) severely limits how efficiently the module can represent complex geometric transformations like rotating or scaling a feature space.
\end{itemize}

Here are some of the concepts I have come up with thus far, most of which are currently being tested in experiments. Additional suggestions or directions for improvements on the algorithm are very welcome during the meeting:

\subsection*{Proposed Novel Extensions}
\begin{itemize}
