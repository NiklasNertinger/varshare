#!/bin/bash
#SBATCH --job-name=varshare-timing-v4
#SBATCH --partition=batch
#SBATCH --time=04:00:00
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --output=/netscratch/%u/varshare/logs/timing_v4_%A_%a.out
#SBATCH --error=/netscratch/%u/varshare/logs/timing_v4_%A_%a.err
#SBATCH --array=1-12

# ============================================================
# VarShare Timing Test v4 — 12 runs, 100k steps each, num-envs=10
# Submit with: sbatch slurm/timing_test_v4.sh
# ============================================================
...
EVAL_FREQ=20000
SEED=1
PROJECT="varshare-timing-mt10-v4"
ANALYSIS_DIR="/netscratch/$USER/varshare/analysis_timing_v4"
...
echo "=============================================="
echo "TIMING TEST V4: Task $SLURM_ARRAY_TASK_ID / 12"
...
EXP_NAME="timing_v4_${ALGO}_h${HDIM}"
...
echo ""
echo "TIMING TEST V4 COMPLETE: $EXP_NAME"
