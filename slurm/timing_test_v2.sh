#!/bin/bash
#SBATCH --job-name=varshare-timing-v2
#SBATCH --partition=batch
#SBATCH --time=04:00:00
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --output=/netscratch/%u/varshare/logs/timing_v2_%A_%a.out
#SBATCH --error=/netscratch/%u/varshare/logs/timing_v2_%A_%a.err
#SBATCH --array=1-12

# ============================================================
# VarShare Timing Test v2 — 12 runs, 150k steps each, num-envs=10
# Submit with: sbatch slurm/timing_test_v2.sh
# ============================================================
...
EVAL_FREQ=30000
SEED=1
PROJECT="varshare-timing-mt10-v2"
ANALYSIS_DIR="/netscratch/$USER/varshare/analysis_timing_v2"
...
echo "=============================================="
echo "TIMING TEST V2: Task $SLURM_ARRAY_TASK_ID / 12"
...
echo ""
echo "TIMING TEST V2 COMPLETE: $EXP_NAME"
