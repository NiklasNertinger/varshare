#!/bin/bash
#SBATCH --job-name=varshare-timing-v5
#SBATCH --partition=batch
#SBATCH --time=04:00:00
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --output=/netscratch/%u/varshare/logs/timing_v5_%A_%a.out
#SBATCH --error=/netscratch/%u/varshare/logs/timing_v5_%A_%a.err
#SBATCH --array=1-12

# ============================================================
# VarShare Timing Test v5 — 12 runs, 100k steps each, num-envs=10
# Uses the newly optimized parallelized AsyncVectorEnv for evaluation!
# Submit with: sbatch slurm/timing_test_v5.sh
# ============================================================
...
EVAL_FREQ=20000
SEED=1
PROJECT="varshare-timing-mt10-v5"
ANALYSIS_DIR="/netscratch/$USER/varshare/analysis_timing_v5"
...
echo "=============================================="
echo "TIMING TEST V5: Task $SLURM_ARRAY_TASK_ID / 12"
...
EXP_NAME="timing_v5_${ALGO}_h${HDIM}"
...
echo ""
echo "TIMING TEST V5 COMPLETE: $EXP_NAME"
